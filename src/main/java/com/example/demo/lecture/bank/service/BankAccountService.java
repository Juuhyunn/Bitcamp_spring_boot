...
public interface BankAccountService {
    ...
    void createAccountNumber(BankAccountDTO bankAccountDTO);
    int checkMyMoney(BankAccountDTO bankAccountDTO);
    int deposit(BankAccountDTO bankAccountDTO);
    int withdraw(BankAccountDTO bankAccountDTO);
    void dropAccountNumber(BankAccountDTO bankAccountDTO);
}